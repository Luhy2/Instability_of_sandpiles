...
Nspace=251;
% Nspace default 200
Aint=1010; % default 10 to 410
Aend=1410; %nondimension length by rint -> hsref
...
% [V,D]=eigs(LLHS,RRHS,50,'smallestabs');
Omegalist=diag(D);
...
hold on
%legend(['N=',num2str(Nspace)])

% legend('50','200','300','600','800')
