...
% FA2=exp((A2-(Am))./(Am/14));
% FA2=ones(1,length(A2));
% FA=[FA1 FA2];
FA=1+5.5*(1+tanh(7*(-1+(2*A/(Aint+Aend+300)))));

FAhalf=FA(1:end-1)+diff(FA)/2;
% FAhalf = smooth(FAhalf);
%%
% Check mesh and FA
  figure()
%   plot(A,'o')
...
%     L11=Ushalf./Ahalf+FAhalf.*(Gamp/(F^2))./(2.*Ushalf)+FAhalf.*((1/R).*(Hshalf.^(1/2)).*((B/cos(sc))^2)./(2.*(Ahalf.^2)));
    L11=Ushalf./Ahalf+(Gamp/(F^2))./(2.*Ushalf)+FAhalf.*((1/R).*(Hshalf.^(1/2)).*((B/cos(sc))^2)./(2.*(Ahalf.^2)));
...
%     L12=Ushalf./Ahalf+FAhalf.*(Gamp/(F^2))./(2.*Ushalf)+FAhalf.*((1/R).*(Hshalf.^(1/2)).*((B/cos(sc))^2)./(2.*(Ahalf.^2)));
    L12=Ushalf./Ahalf+(Gamp/(F^2))./(2.*Ushalf)+FAhalf.*((1/R).*(Hshalf.^(1/2)).*((B/cos(sc))^2)./(2.*(Ahalf.^2)));
...
%     L19=FAhalf.*(eta/(F^2))./(2.*Ushalf)+FAhalf.*((1/R).*(Hshalf.^(1/2)).*((B/cos(sc))^2)./(2.*(Ahalf.^2)));
    L19=(eta/(F^2))./(2.*Ushalf)+FAhalf.*((1/R).*(Hshalf.^(1/2)).*((B/cos(sc))^2)./(2.*(Ahalf.^2)));
...
%     L20=FAhalf.*(eta/(F^2))./(2.*Ushalf)+FAhalf.*((1/R).*(Hshalf.^(1/2)).*((B/cos(sc))^2)./(2.*(Ahalf.^2)));
    L20=(eta/(F^2))./(2.*Ushalf)+FAhalf.*((1/R).*(Hshalf.^(1/2)).*((B/cos(sc))^2)./(2.*(Ahalf.^2)));
