...
legend('Im[\lambda]_{real}-Im[\lambda]_{base} at k_b=0','Location','northwest')

%colorbar;
xlabel('k_a')
ylabel('k_{\theta}')
zlabel('\Delta Im[\lambda]')
title('k_b=0')
...
legend('Im[\lambda]_{real}-Im[\lambda]_{base} at k_b=1','Location','northwest')
...
legend('Im[\lambda]_{real}-Im[\lambda]_{base} at k_b=5','Location','northwest')
...
legend('Im[\lambda]_{real}-Im[\lambda]_{base} at k_b=10','Location','northwest')
